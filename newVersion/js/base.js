// 信息披露
$(".xlMessage_li>a").mouseenter(function () {
    $(".xlUs").hide();
    $(".xlMessage").slideDown(100);
});
$(".xlMessage_li>a").mouseleave(function () {
    $(".xlUs").hide();
});
...
// 关于鑫路
$(".xlUs_li>a").mouseenter(function () {
    $(".xlMessage").hide();
    $(".xlUs").slideDown(100);
});
$(".xlUs_li>a").mouseleave(function () {
    $(".xlMessage").hide();
});
...
$(".xlHead_topbar").mouseenter(function () {
    $(".xlUs").hide();
    $(".xlMessage").hide();
});
$(".xlHead_left").mouseenter(function(){
	$(".xlUs").hide();
    $(".xlMessage").hide();
});
$(".xlUser").mouseenter(function(){
	$(".xlUs").hide();
    $(".xlMessage").hide();
});
